...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-enom.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-enom)
...
```bash
php artisan vendor:publish --tag="laravel-enom-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-enom-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-enom-views"
```

## Usage

```php
$enom = new Sensson\Enom();
echo $enom->echoPhrase('Hello, Sensson!');
```
